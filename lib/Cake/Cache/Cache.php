 ...
 * - `servers' Used by memcached. Give the address of the memcached servers to use.
 * - `compress` Used by memcached. Enables memcached's compressed format.
 ...
 * - `password` Used by Redis. Password for Redis
 *
